...
const DigitalReceiptData = ({ feature, currentStep, triggerRefs }) => {  
        ...
        <div className='DigitalReceiptData w-100 d-flex flex-column align-items-center'>  
            ...
            >  
                ...
                <div className='d-flex justify-content-center mb-3 w-100'>  
                    <p   
                        ref={(feature === 'digitalReceipts' || feature === 'receipts') ? triggerRefs?.step4 : null}  
            ...
            <div   
                ...
                ref={(feature === 'digitalReceipts' || feature === 'receipts') ? triggerRefs?.step3 : null}  
            >  
