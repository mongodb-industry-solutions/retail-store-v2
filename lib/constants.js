...
/** Product cards / detail modal: show low-stock emphasis when quantity is known and in 1..LOW_STOCK_THRESHOLD */
...
export const NEXT_BEST_ACTIONS_TYPES = {
  ...
  FREE_DELIVERY: {name: 'shipping-discount', label: "Shipping Discount", description: 'Offering free delivery to incentivize users to complete their purchase, especially when they show exit intent.'}
}
