...
export const NEXT_BEST_ACTIONS_TYPES = {
  PRODUCT_RECOMMENDATION: {name: 'product-recommendation', description: 'Suggesting relevant products to the user based on their browsing behavior to encourage purchase.'},
  SOCIAL_PROOF_NOTIFICATION: {name: 'social-proof-notification', description: 'Leveraging social proof by notifying users of popular products or recent purchases to build trust and encourage buying.'},
  FREE_DELIVERY: {name: 'free-delivery', description: 'Offering free delivery to incentivize users to complete their purchase, especially when they show exit intent.'}
}
