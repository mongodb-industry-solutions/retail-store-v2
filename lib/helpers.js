  ...
  switch (event) {
    case "heartbeat":
      return {
        ...
        metadata: {
          active: true,
          userEmail: optionals.userEmail || "unknown",
          userName: optionals.userName || "unknown",
          ...optionals,
        },
      };
    ...
    case "view-product":
      return {
        ...basePayload,
        metadata: {
          productId: optionals.productId,
          productName: optionals.productName,
          masterCategory: optionals.masterCategory,
          subCategory: optionals.subCategory,
          articleType: optionals.articleType,
          vai_text_embedding: optionals.vai_text_embedding || [],
          ...optionals,
        },
      };
    ...
    case "exit-intent":
      return {
        ...basePayload,
        metadata: {
          exitMethod: optionals.exitMethod || "mouse-leave",
          ...optionals,
        },
      };
