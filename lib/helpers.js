...
import { addUsersNewOrder, setSelectedUserLastRecommendations, updateUsersOrder } from "@/redux/slices/UserSlice";
...
export const calculateInitialMessage = async (minimizedOrderSchema) => {
    ...
    let txt =  `Hi there! Today's date is ${prettifyDateFormat(new Date())} and I am a GenAI Chatbot design to assist you! Here are your latest orders: `
    let html = `<div>
