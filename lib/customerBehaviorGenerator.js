    ...
    const customer_behaviour_docs = [
      {
        ...
        sid: sid,
        signal: "exit-risk",
        evidence: "focus above 0.5 sustained on product in last 30s",
        severity: "high",
      },
      {
        uid: uid,
    ...
    const next_best_actions = [
      {
        ...
        actionMetadata: {
          title: "Popular pick!",
          message:
            "25 people bought this shower curtain today — grab yours before it's gone.",
          product: {
...

      {
        ...
        actionMetadata: {
          ...
          product: {
            productId: "67192b3f64d161905fbe7795",
            productName:
              "AmazonBasics Toilet Paper Holder - Modern, 1-Piece, Black",
...

      {
        ...
        actionMetadata: {
          ...
          message:
            "Hurry — only 5 units of the Ceramic Soap Dispenser remain in stock.",
          product: {
            productId: "67192b3f64d161905fbe77c7",
            productName:
              'AmazonBasics Anti-Fatigue Mat Marbleized Composite Mat 7/8" Thick 3x5 Blue/White',
...

      {
        ...
        actionMetadata: {
          title: "Before you go...",
          message:
            "Complete checkout now and get free shipping — for a limited time!",
        },
        redeemed: false,
      },

      {
        ...
        actionMetadata: {
          ...
          message:
            "Check out this stylish stainless steel toothbrush holder — pairs perfectly with your bathroom set.",
          product: {
...

      {
        ...
        actionMetadata: {
          ...
          message:
            "Free delivery available today only — finish your purchase before midnight.",
        },
        redeemed: false,
      },

      {
        ...
        actionMetadata: {
          ...
          message:
            "You may like this minimalist towel hook based on your recent browsing.",
          product: {
